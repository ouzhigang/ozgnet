...
namespace OZGNet.Data
{
    ...
    public class OleDbHelper : IDataHelper
    {
        ...
        //默认使用Access2000 or 2003
        private Options.OleDbSelect _DBSelect = (Options.OleDbSelect)1;
        ...
        /// <param name="isLocal">是否为本地路径(false为服务器虚拟路径)</param>
        public OleDbHelper(string dbPath, bool isLocal)
        {
            this._dbPath = dbPath;
            this._isLocal = isLocal;
            this._connstring = getConnString();
        }
        /// <summary>
        /// 实例化OleDbHelper
        /// </summary>
        ...
        public OleDbHelper(string dbPath, bool isLocal, Options.OleDbSelect DBSelect)
        {
            this._dbPath = dbPath;
            this._isLocal = isLocal;
        ...
        /// 选择数据库类型
        /// </summary>
        protected Options.OleDbSelect DBSelect
        {
            get
            {
            ...
            set
            {
                this._DBSelect = value;
            }
        } 
        

        /// <summary>
        /// 是否使用本地路径,false则使用服务器路径
        /// </summary>
        ...
        public IDataReader AspNetPagerProcedure(Wuqi.Webdiyer.AspNetPager pager, string sql)
        {
            ...
            parameters.Add(new OleDbParameter("@pageindex", pager.CurrentPageIndex));
            parameters.Add(new OleDbParameter("@pagesize", pager.PageSize));
            parameters.Add(new OleDbParameter("@docount", "0"));
        ...
        {
            return new OleDbConnection(this._connstring);
        }
