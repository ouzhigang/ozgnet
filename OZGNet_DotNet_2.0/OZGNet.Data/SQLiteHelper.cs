...
namespace OZGNet.Data
{
    ...
    public class SQLiteHelper : IDataHelper
    {
        ...
        public SQLiteHelper(string dbPath, bool isLocal)
        {
            this._dbPath = dbPath;
        ...
        protected string getConnString()
        {
            ...
            if (this._isLocal)
            {
                connstring = "Data Source=" + this._dbPath;
            }
            else
            {
                connstring = "Data Source=" + System.Web.HttpContext.Current.Server.MapPath(this._dbPath);
            }
            return connstring;
        }
        #endregion
        ...
        public IDataReader AspNetPagerProcedure(Wuqi.Webdiyer.AspNetPager pager, string sql)
        {
            ...
            parameters.Add(new SQLiteParameter("@pageindex", pager.CurrentPageIndex));
            parameters.Add(new SQLiteParameter("@pagesize", pager.PageSize));
            parameters.Add(new SQLiteParameter("@docount", "0"));
