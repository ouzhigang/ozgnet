...
namespace OZGNet.Data
{
    ...
    public class SqlHelper:IDataHelper
    {
        ...
        public IDataReader AspNetPagerProcedure(Wuqi.Webdiyer.AspNetPager pager, string sql)
        {
            ...
            parameters.Add(new SqlParameter("@pageindex", pager.CurrentPageIndex));
            parameters.Add(new SqlParameter("@pagesize", pager.PageSize));
            parameters.Add(new SqlParameter("@docount", "0"));
