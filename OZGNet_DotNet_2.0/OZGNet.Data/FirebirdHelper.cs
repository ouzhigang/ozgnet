...
namespace OZGNet.Data
{
    ...
    public class FirebirdHelper : IDataHelper
    {
        ...
        public IDataReader AspNetPagerProcedure(Wuqi.Webdiyer.AspNetPager pager, string sql)
        {
            ...
            parameters.Add(new FbParameter("@pageindex", pager.CurrentPageIndex));
            parameters.Add(new FbParameter("@pagesize", pager.PageSize));
            parameters.Add(new FbParameter("@docount", "0"));
