...
namespace OZGNet.GDI
{
    ...
    public class Utility
    {
        ...
        public static void LayoutForASPJpeg(string source_pic, string save_pic, int layout_left, int layout_top, int layout_width, int layout_height, int layout_zoom, int save_width, int disp_width)
        {
            ...
            ASPJPEGLib.ASPJpegClass Jpeg = new ASPJPEGLib.ASPJpegClass();
            Jpeg.Open(source_pic);
            if (zoom != 0)
            {
                Jpeg.Width = Jpeg.OriginalWidth * zoom / 100;
                Jpeg.Height = Jpeg.OriginalHeight * zoom / 100;
            }
            else
            {
            ...
            Jpeg.Quality = 85;
            double szoom = (double)Jpeg.OriginalWidth / (double)disp_width;  //计算出截图前显示的尺寸与实际尺寸的比例
            ...
            Jpeg.Crop(Crop_X0, Crop_Y0, Crop_X1, Crop_Y1); //开始切割

            int Height = (int)Math.Round((double)(Jpeg.OriginalHeight * save_width) / (double)Jpeg.OriginalWidth);
            Jpeg.Width = save_width;
            Jpeg.Height = Height;


            Jpeg.Save(save_pic); //保存
            Jpeg.Close();
            Jpeg = null;
        }
        #endregion
        ...
        public static void ShuiYinPic(string Path, string Path_syp, string Path_sypf, OZGNet.Options.ShuiYinPicPoint point)
        {
        ...
        public static void ShuiYinPic(string Path, string Path_syp, string Path_sypf, OZGNet.Options.ShuiYinPicPoint point, bool delete)
        {
            ...
            if (point == OZGNet.Options.ShuiYinPicPoint.LeftTop)
            { 
                //左上
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.MiddleTop)
            {
                //中上
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.RightTop)
            {
                //右上
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.LeftMiddle)
            {
                //左中
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.Middle)
            {
                //中间
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.RightMiddle)
            {
                //右中
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.LeftDown)
            {
                //左下
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.MiddleDown)
            {
                //中下
            ...
            else if (point == OZGNet.Options.ShuiYinPicPoint.RightDown)
            {
                //右下
